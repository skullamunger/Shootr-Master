...
class GameScene: SKScene {
    ...
    // 1
    var player = SKSpriteNode(imageNamed: "squidy")
    ...
    override func didMove(to view: SKView) {
        ...
        HighScoreLabel.position = CGPoint(x: size.width/2, y: size.height/3.3)
        ...
        let backgroundMusic = SKAudioNode(fileNamed: "")
...
func addPauseButton(){
    ...
    pauseButton.position = CGPoint(x: size.width * 0.5, y: size.height * 0.8)
    pauseButton.xScale = 0.01
    pauseButton.yScale = 0.01
    ...
    func addMonster() {
        // Create sprite
        let monster = SKSpriteNode(imageNamed: "sharky")
